...
my %me2x5 = &makescorematrix('/scratch/cqs/udn/pipeline/submodels/splicemodels/me2x5');
my %seq = &makesequencematrix('/scratch/cqs/udn/pipeline/submodels/splicemodels/splice5sequences');
